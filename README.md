...
Si no deseas ejecutarlo en local, puedes acceder directamente a la versión desplegada en Streamlit Cloud:

**[🔗 Acceder al Dashboard](https://proyectofinalvisuadashboard.streamlit.app/)**
